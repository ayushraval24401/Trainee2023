...
namespace CustomerManagement.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public ActionResult GetAll()
        {
            ...
            try
            {
                var customers = _customerCollection.Find(c => true).ToList();
        ...
        public ActionResult Get(string name = "")
        {
            ...
            try
            {
                ...
                var customers = _customerCollection.Find(c => c.name.ToLower().Contains(name.ToLower())).ToList();
        ...
        public ActionResult Put(string id, Customer customerIn)
        {
            ...
            try
            {
                ...
                var customer = _customerCollection.Find(c => c.Id == objectId).FirstOrDefault();

                if (customer != null)
                {
                    customerIn.Id = objectId;

                    _customerCollection.ReplaceOne(c => c.Id == objectId, customerIn);
        ...
        public ActionResult Delete(string id)
        {
            ...
            try
            {
                var customer = _customerCollection.Find(c => c.Id.ToString() == id).FirstOrDefault();

                if (customer != null)
                {
                    _customerCollection.DeleteOne(c => c.Id.ToString() == id);
